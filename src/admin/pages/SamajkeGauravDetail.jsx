        ...
        if (data && id !== "save") {
            setForm({
                ...
                data: {
                    ...
                    category: data?.data?.category || "games",
                    biography: data?.data?.biography || "",
                    achievements: data?.data?.achievements?.length ? data?.data.achievements : [""],
        ...
        <form onSubmit={save} className="space-y-6 border p-6 rounded-xl bg-white">
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <label className="block text-sm">
                        <span className="font-semibold">Time Line</span>
                        <select
                    ...
                    <div className="border p-4 rounded-lg mt-6 bg-slate-50">
                        <h3 className="text-lg font-semibold mb-2">{form.data.category} Details</h3>
                        ...
                        <div className="mt-3">
                            ...
                            {form?.data.achievements.map((a, i) => (
                                <div key={"data-ach-" + i} className="flex gap-2 mt-2">
                                    <input
                                        value={a}
                                        onChange={(e) => {
                                            const newList = [...form?.data.achievements];
                                            newList[i] = e.target.value;
                                            update("data", "achievements", newList);
                                        }}
                            ...
                            <button
                                type="button"
                                onClick={() =>
                                    update("data", "achievements", [
                                        ...form?.data.achievements,
                                        "",
                                    ])
                                }
                        ...
                        <div className="mt-4">
                            ...
                            <FileDrop
                                ...
                                onFile={(f) => uploadGalleryPhoto("data", f)}
                            />

                            <div className="grid grid-cols-3 gap-3 mt-3">
                                {form?.data.gallery.map((img, i) => (
